import 'package:Delivery_App/fastfood/CartScreen/cart_view.dart';
import 'package:Delivery_App/model/item_model.dart';
import 'package:Delivery_App/widgets/network_image.dart';
import 'package:flutter/material.dart';
import 'package:persistent_shopping_cart/model/cart_model.dart';
import 'package:persistent_shopping_cart/persistent_shopping_cart.dart';

class AddToBucket extends StatefulWidget {
  const AddToBucket({super.key});

  @override
  State<AddToBucket> createState() => _AddToBucketState();
}

class _AddToBucketState extends State<AddToBucket> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        actions: [
         ...
         backgroundColor: Colors.black,
        title: const Text('AFC',style: TextStyle(color: Colors.pink,fontSize: 20,fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            const Text('Ala-Carte-&-Combos',style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500,color: Colors.white),),
